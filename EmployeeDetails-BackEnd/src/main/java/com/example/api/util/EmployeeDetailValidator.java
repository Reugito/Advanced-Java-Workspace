...
public class EmployeeDetailValidator  {
	...
	public boolean isStatusValid(@NotNull(message = "add status") @NotEmpty(message = "add status") String status) throws CustomException {
	...
	public boolean isAddressValid(@NotNull(message = "address should't be null")
	@Pattern(regexp = "^[A-Z]{1}[a-z]{2,}$", message = "address not valid")
	String firstName) {
		log.info("/EmployeeDetailValidator.isAddressValid()");
		return true;
	}
	
	public boolean isOrderValid(String order) throws CustomException {
	...
	public boolean isEntityNameValid(String entityName) throws CustomException {
		if(entityName.equals("firstName") || entityName.equals("lastName") || entityName.equals("status")
				|| entityName.equals("phoneNo") || entityName.equals("address") || entityName.equals("email")
				|| entityName.equals("startDate") || entityName.equals("endDate") || entityName.equals("id"))
			return true;
		else
			throw new CustomException("Invalid EntityName");
