...
public class EmployeeDetailsController {
	...
	public ResponseDTO getEmployeeDetailsWithParam(@RequestParam String searchDTO) throws Exception {
		try {
			...
			} else if (dto.emailId != null) {
				if (validator.isEmailIdValid(dto.emailId) && dto.id == null && dto.firstName == null
						&& dto.lastName == null && dto.startDate == null && dto.endDate == null)
					return empServices.findByEmail(dto.emailId);
			} else if (dto.address != null && dto.id == null && dto.firstName == null && dto.lastName == null
					&& dto.startDate == null && dto.endDate == null) {
				if (validator.isAddressValid(dto.address))
					return empServices.findByAddress(dto.address);
			...
			}else if(dto.status !=null && dto.id == null && dto.firstName == null && dto.lastName == null && dto.startDate == null
					&& dto.endDate == null) {
				if (validator.isStatusValid(dto.status))
					return empServices.findAllByStatusDetails(dto.status);
			}
			else if (dto.entityName != null && dto.order != null && dto.id == null && dto.firstName == null
					&& dto.lastName == null && dto.startDate == null && dto.endDate == null) {
				if (validator.isOrderValid(dto.order) && validator.isEntityNameValid(dto.entityName)) {
					if (dto.order.equals("asc"))
						return empServices.sortByEachEntityAcending(dto.entityName);
					else if (dto.order.equals("desc"))
						return empServices.sortByEachEntityInDescOrder(dto.entityName);
				}
			} else if (dto.pageNo != null && dto.id == null && dto.firstName == null && dto.lastName == null
					&& dto.startDate == null && dto.endDate == null) {
	...
	@GetMapping("/sort/{entityName}")
	private ResponseDTO sortByEachEntityAscending(@PathVariable String entityName) {
		return empServices.sortByEachEntityAcending(entityName);
	}
